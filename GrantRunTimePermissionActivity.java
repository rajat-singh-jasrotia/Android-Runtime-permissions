...
private SharedPreferences mSharedPreference;
     ...
     *
     */
    public void grantPermission(final String[] permissionList, final int requestCode, String explanation, View view, String groupTag)
    {
        mGroupTag=groupTag;
        mSharedPreference = getSharedPreferences("permissionStatus",MODE_PRIVATE);
        boolean isGranted=true;
        for(String permissionItem: permissionList){
            if (ActivityCompat.checkSelfPermission(this, permissionItem) != (int) PackageManager.PERMISSION_GRANTED){
                isGranted=false;
                break;
            }
        }
                ...
                Snackbar.make(view, explanation+"", Snackbar.LENGTH_INDEFINITE)
                        .setAction("OK", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ActivityCompat.requestPermissions(GrantRunTimePermissionActivity.this, permissionList, requestCode);
                            }
                        })
                        .show();
                return;
